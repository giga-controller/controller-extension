...
export default defineUnlistedScript(() => {
  ...
  const initializeButton = async () => {
    if (
      ...
      const GOOGLE_CLOUD_ENABLE_INTEGRATION_API_BASE_URL: string = "https://console.cloud.google.com/marketplace/product/google"
      const ENABLE_INTEGRATION_API_CLASS_QUERY: string = constructClassQuery('mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base gmat-mdc-button cm-button cfc-tooltip cfc-tooltip-disable-user-select-on-touch-device ng-star-inserted')
      ...
      const API_DETAILS_BASE_URL: string = "https://console.cloud.google.com/apis/api/";
