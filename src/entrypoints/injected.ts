...
const GOOGLE_CLOUD_WELCOME_BASE_URL = "https://console.cloud.google.com/welcome";
const GOOGLE_CLOUD_MARKETPLACE_BASE_URL = "https://console.cloud.google.com/marketplace/product/google";
const GOOGLE_CLOUD_API_BASE_URL: string = `https://console.cloud.google.com/apis/api`;
const GOOGLE_CLOUD_OAUTH_CONSENT_BASE_URL = "https://console.cloud.google.com/apis/credentials/consent";
  ...
  const initializeButton = async () => {
    ...
    tasks.push((async () => {
      ...
      const injectPartOneButtonRequest = injectButtonRequestSchema.parse({
        autoClick: false,
        baseUrl: GOOGLE_CLOUD_WELCOME_BASE_URL,
    ...
    tasks.push((async () => {
      if (window.location.href.includes(SLACK_HOME_PAGE_URL)) {
    ...
    tasks.push((async () => {
      if (window.location.href === X_HOME_PAGE_URL) {
