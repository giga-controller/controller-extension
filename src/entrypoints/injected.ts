...
export default defineUnlistedScript(() => {
  const createGoogleOauth2Application = async () => {
    ...
    const USER_SUPPORT_EMAIL_SELECTION_CLASS_QUERY: string =
      constructClassQuery("mat-mdc-option mdc-list-item ng-star-inserted");
    ...
    const retrieveUserSupportEmailSelectionRequest =
